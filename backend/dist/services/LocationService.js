...
exports.UserProfileStorage = exports.LocationService = void 0;
/**
...
class LocationService {
     ...
     */
    static validateAirportCode(code) {
        const errors = [];
        const warnings = [];
    ...
    static validatePostalCode(input) {
        ...
        const matchedCountry = Object.entries(this.POSTAL_CODE_PATTERNS).find(([_, pattern]) => pattern.test(input.toUpperCase()));
        if (matchedCountry) {
     ...
     */
    static validateCityCountry(input) {
        const errors = [];
        const warnings = [];
     ...
     */
    static async parseAirportCode(code) {
     ...
     */
    static async parseCityCountry(city, country) {
     ...
     */
    static async parseSingleLocation(location) {
     ...
     */
    static guessAirportCode(city, country) {
...
LocationService.AIRPORT_CODE_REGEX = /^[A-Z]{3}$/;
LocationService.POSTAL_CODE_PATTERNS = {
    US: /^\d{5}(-\d{4})?$/,
...
UserProfileStorage.STORAGE_KEY = 'travel_bucket_list_user_profile';
